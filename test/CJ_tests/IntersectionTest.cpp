...
typedef boost::variant<Segment_3, Point_3, std::vector<Point_3>> IntersectResult;
...
public:
    ...
    static std::vector<Plane_3> defineCubePlanes() {
        Mesh cube = buildCubeMesh();
        return {
            Plane_3(Point_3(cube.coordinates[0][0], cube.coordinates[0][1], cube.coordinates[0][2]), 
            ...
            Plane_3(Point_3(cube.coordinates[4][0], cube.coordinates[4][1], cube.coordinates[4][2]),
            ...
            Plane_3(Point_3(cube.coordinates[1][0], cube.coordinates[1][1], cube.coordinates[1][2]),
                    Point_3(cube.coordinates[5][0], cube.coordinates[5][1], cube.coordinates[5][2]),
            ...
            Plane_3(Point_3(cube.coordinates[2][0], cube.coordinates[2][1], cube.coordinates[2][2]),
                    Point_3(cube.coordinates[3][0], cube.coordinates[3][1], cube.coordinates[3][2]),
                    Point_3(cube.coordinates[6][0], cube.coordinates[6][1], cube.coordinates[6][2]))
        };
    }

    static boost::optional<IntersectResult> findMaxIntersection(const Segment_3& segment, const std::vector<Plane_3>& planes) {
...
TEST_F(IntersectionTest, CubeFaceIntersections) {
    Mesh cube = buildCubeMesh();
    Segment_3 segment(Point_3(0.5, 0.5, -1), Point_3(0.5, 0.5, 0.5));

    std::vector<Plane_3> planes = defineCubePlanes();

    auto max_intersection = findMaxIntersection(segment, planes);
